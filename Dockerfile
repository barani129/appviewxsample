...
COPY --chown=golanguser:golanguser internal/ClusterIssuer/ internal/ClusterIssuer/
COPY --chown=golanguser:golanguser internal/ClusterIssuer/util/ internal/ClusterIssuer/util/
COPY --chown=golanguser:golanguser internal/ClusterIssuer/signer/ internal/ClusterIssuer/signer/
