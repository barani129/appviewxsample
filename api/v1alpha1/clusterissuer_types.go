...
type ClusterIssuerSpec struct {
	// URL is the REST API login URL for the external issuer to check/renew/create certificates
...
type ClusterIssuerStatus struct {
	...
	// last successful timestamp of URL reachability
	// +optional
...
// +kubebuilder:printcolumn:name="LastSuccessfulPollTime",type="string",JSONPath=".status.lastPollTime",description="timestamp of last successful reachability"
